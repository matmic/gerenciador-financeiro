			...
			$this->widget('zii.widgets.CMenu',array(
				'items'=>array(
					...
					array('label'=>'GRÁFICOS', 'visible' => !Yii::app()->user->isGuest, 'items'=>array(
						array('label'=>'Receitas por Categoria', 'url'=>array("/orcamento/graficoCategoria", 'tipo'=>'1')),
						array('label'=>'Despesas por Categoria', 'url'=>array("/orcamento/graficoCategoria", 'tipo'=>'2')),
						array('label'=>'Receitas por Estabelecimento', 'url'=>array("/orcamento/graficoEstabelecimento", 'tipo'=>"1")),
						array('label'=>'Despesas por Estabelecimento', 'url'=>array("/orcamento/graficoEstabelecimento", "tipo"=>"2")),							
						),		
					),
				),
			));
