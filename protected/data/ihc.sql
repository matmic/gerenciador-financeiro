...
--
-- Host: 127.0.0.1
-- Generation Time: 03-Jun-2016 às 17:53
...
(1, 'Rua Tomas Flores', 171, '801', 'Bom Fim', '90035201', 'Porto Alegre', 21, 'N');
...
(1, 'Matheus Michel', '11111111111', 'matmic08@gmail.com', 'M', 1, 6, '(51) 81913203', '1993-10-08', '202cb962ac59075b964b07152d234b70', '0.00', 'N');
...
--
ALTER TABLE `categoria`
  MODIFY `CodCategoria` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `endereco`
--
ALTER TABLE `endereco`
  MODIFY `CodEndereco` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `estabelecimento`
  MODIFY `CodEstabelecimento` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `pessoa`
  MODIFY `CodPessoa` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
