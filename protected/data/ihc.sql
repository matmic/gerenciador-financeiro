...
--
-- Host: 127.0.0.1
-- Generation Time: 02-Jun-2016 às 20:30
...
--
ALTER TABLE `categoria`
  MODIFY `CodCategoria` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `pessoa`
  MODIFY `CodPessoa` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
